...
|--------------|----------------------|---------------|
| queueId      | Unique identifier of the deals queue action   | long          |
...
<TabBar>
    <TabItem label="Quorum">
        <CodeEditor code={
       `
curl -X GET "http://qrm1.kekker.com/api/queue/1801"
...
-H "x-api-version: 2.0"
    ...
    <TabItem label="Hyperledger">
                <CodeEditor code={
                `
curl -X GET "http://hlf1.kekker.com/api/queue/1801"
-H "accept: application/json"
-H "Authorization: {AUTHORIZATION}"
-H "channel: {CHANNEL}"
-H "x-api-version: 2.0"
   ...
   <TabItem label="Ethereum">
                   <CodeEditor code={
                  `
curl -X GET "http://eth1.kekker.com/api/queue/1801"
-H "accept: application/json"
-H "Authorization: {AUTHORIZATION}"
-H "channel: {CHANNEL}"
-H "x-api-version: 2.0"
...
<TabBar>
    <TabItem label="Quorum">
        <CodeEditor code={
       `
curl -X DELETE "http://qrm1.kekker.com/api/queue/1801"
-H "accept: application/json"
-H "Authorization: {AUTHORIZATION}"
-H "channel: {CHANNEL}"
-H "x-api-version: 2.0"
    ...
    <TabItem label="Hyperledger">
                <CodeEditor code={
                `
curl -X DELETE "http://hlf1.kekker.com/api/queue/1801"
-H "accept: application/json"
-H "Authorization: {AUTHORIZATION}"
-H "channel: {CHANNEL}"
-H "x-api-version: 2.0"
   ...
   <TabItem label="Ethereum">
                   <CodeEditor code={
                  `
curl -X DELETE "http://eth1.kekker.com/api/queue/1801"
-H "accept: application/json"
-H "Authorization: {AUTHORIZATION}"
-H "channel: {CHANNEL}"
-H "x-api-version: 2.0"
