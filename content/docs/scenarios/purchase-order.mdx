...
<TabBar>
    <TabItem label="Quorum">
            <CodeEditor code={
           `
curl -X POST "http://qrm1.kekker.com/api/deals/setstatus"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Content-Type: application/json"
-H "Authorization: {AUTHORIZATION}"
-d "
{
 ...
 \\"parameters\\": []
    ...
    <TabItem label="Hyperledger">
         <CodeEditor code={
           `
curl -X POST "http://hlf1.kekker.com/api/deals/setstatus"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Content-Type: application/json"
-H "Authorization: {AUTHORIZATION}"
-d "
{
 ...
 \\"parameters\\": []
    ...
    <TabItem label="Ethereum">
       <CodeEditor code={
       `
curl -X POST "http://eth1.kekker.com/api/deals/setstatus"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Content-Type: application/json"
-H "Authorization: {AUTHORIZATION}"
...
<TabBar>
    <TabItem label="Quorum">
                <CodeEditor code={
               `
curl -X GET "http://qrm2.kekker.com/api/deals/{UID}"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Authorization: {AUTHORIZATION}"
               `
    ...
    <TabItem label="Hyperledger">
            <CodeEditor code={
           `
curl -X GET "http://hlf2.kekker.com/api/deals/{UID}"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Authorization: {AUTHORIZATION}"
           `
    ...
    <TabItem label="Ethereum">
       <CodeEditor code={
       `
curl -X GET "http://eth2.kekker.com/api/deals/{UID}"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Authorization: {AUTHORIZATION}"
       `
...
<TabBar>
    <TabItem label="Quorum">
        <CodeEditor code={
           `
curl -X POST "http://qrm2.kekker.com/api/deals/setstatus"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Content-Type: application/json"
-H "Authorization: {AUTHORIZATION}"
-d "
{
  ...
  \\"parameters\\": [
    ...
    <TabItem label="Hyperledger">
        <CodeEditor code={
       `
curl -X POST "http://hlf2.kekker.com/api/deals/setstatus"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Content-Type: application/json"
-H "Authorization: {AUTHORIZATION}"
-d "
{
  ...
  \\"parameters\\": [
    ...
    <TabItem label="Ethereum">
       <CodeEditor code={
       `
curl -X POST "http://eth2.kekker.com/api/deals/setstatus"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Content-Type: application/json"
-H "Authorization: {AUTHORIZATION}"
...
<TabBar>
    <TabItem label="Quorum">
        <CodeEditor code={
       `
curl -X GET "http://qrm1.kekker.com/api/deals/{UID}"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Authorization: {AUTHORIZATION}"
       `
    ...
    <TabItem label="Hyperledger">
        <CodeEditor code={
       `
curl -X GET "http://hlf1.kekker.com/api/deals/{UID}"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Authorization: {AUTHORIZATION}"
       `
    ...
    <TabItem label="Ethereum">
       <CodeEditor code={
       `
curl -X GET "http://eth1.kekker.com/api/deals/{UID}"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Authorization: {AUTHORIZATION}"
       `
...
If all is ok, the response code is `200`. The response body is empty.

## 7. Make sure on Seller node the Deal status is Ordered
Use `GET`-method call `/api/deals/{UID}` where `{UID}` is the Deal identifier
