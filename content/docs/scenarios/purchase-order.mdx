...
-d "
{
 ...
 "parameters": []
    ...
    <TabItem label="HyperLedger">
        <CodeEditor code={
       `
curl -X POST "http://hyperdemoclient1.kekker.com/api/deals/setstatus"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Content-Type: application/json"
-H "Authorization: {AUTHORIZATION}"
...
<TabBar>
    <TabItem label="Ethereum">
       <CodeEditor code={
       `
curl -X POST "http://democlient2.kekker.com/api/deals/setstatus"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Content-Type: application/json"
-H "Authorization: {AUTHORIZATION}"
-d "
{
  ...
  "parameters": [
    ...
    <TabItem label="HyperLedger">
        <CodeEditor code={
       `
curl -X POST "http://hyperdemoclient2.kekker.com/api/deals/setstatus"
-H "Accept: application/json"
-H "Channel: {CHANNEL}"
-H "Content-Type: application/json"
-H "Authorization: {AUTHORIZATION}"
